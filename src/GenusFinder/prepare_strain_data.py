...
def main(argv=None):
    ...
    p.add_argument(
        "--db-dir", help=("Filepath to download the files to " "[default: db/]")
    )
    ...
    ltp_align_fp = use_or_download(args.ltp_align_fp, LTP_ALIGN_URL, db_dir)
    ltp_tree_fp = use_or_download(None, LTP_TREE_URL, db_dir)
